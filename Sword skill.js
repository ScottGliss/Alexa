...
{
    var sentence = item.SwordName + " is a " + item.Style+ "Sword from the Country of " + item.Country + " It was used by warriors in the " + item.Century+ " A brief history of the sword " + item.Description;
    return sentence;
}
...
{
    return "Here is your " + counter + "th question.  What is the " + formatCasing(property) + " of "  + item.SwordName + "?";
...
function getAnswer(property, item)
{
    ...
    {
        case "Style":
            return "The " + formatCasing(property) + " of " + item.SwordName + " is <say-as interpret-as='spell-out'>" + item[property] + "</say-as>. "
        break;
        default:
            return "The " + formatCasing(property) + " of " + item.SwordName + " is " + item[property] + ". "
        break;
    }
}
...
var WELCOME_MESSAGE = "Welcome to the Historical Swords Quiz Game!  You can ask me about swords from several countries including Japan or you can ask me to start a quiz.  What would you like to do?";  

//This is the message a user will hear when they start a quiz.
var START_QUIZ_MESSAGE = "OK.  I will ask you 10 questions about Swords.";

//This is the message a user will hear when they try to cancel or stop the skill, or when they finish a quiz.
var EXIT_SKILL_MESSAGE = "Thank you for playing the Historical Swords Quiz Game!  Let's play again soon!";

//This is the message a user will hear after they ask (and hear) about a specific data element.
var REPROMPT_SPEECH = "Which other sword or country would you like to know about?";

//This is the message a user will hear when they ask Alexa for help in your skill.
var HELP_MESSAGE = "I know lots of things about Historical Swords.  You can ask me about a country or style, and I'll tell you what I know.  You can also test your knowledge by asking me to start a quiz.  What would you like to do?";
